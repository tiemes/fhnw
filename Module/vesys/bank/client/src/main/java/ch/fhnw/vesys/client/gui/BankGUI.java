...
package ch.fhnw.vesys.client.gui;

import ch.fhnw.vesys.client.gui.tests.BankTest;
...
public class BankGUI extends JFrame {
    ...
    public BankGUI(BankDriver server) {
        ...
        BankTest test;
        test = loadTest("ch.fhnw.vesys.client.gui.tests.EfficiencyTestDS");
        if (test != null) {
            tests.add(test);
        }
        test = loadTest("ch.fhnw.vesys.client.gui.tests.EfficiencyTestCONPR");
        if (test != null) {
            tests.add(test);
        }
        test = loadTest("ch.fhnw.vesys.client.gui.tests.WarmUp");
        if (test != null) {
            tests.add(test);
        }
        test = loadTest("ch.fhnw.vesys.client.gui.tests.ThreadingTest");
        if (test != null) {
            tests.add(test);
        }
        test = loadTest("ch.fhnw.vesys.client.gui.tests.FunctionalityTest");
        if (test != null) {
            tests.add(test);
        }
        test = loadTest("ch.fhnw.vesys.client.gui.tests.TransferTest");
        if (test != null) {
            tests.add(test);
        }
        test = loadTest("ch.fhnw.vesys.client.gui.tests.ConcurrentReads");
        if (test != null) {
            tests.add(test);
        }
